<template>
    ...
    <div class="flex items-center justify-between">
        <!-- <pre>{{ model.data.options.length }}</pre> -->
    ...
    <div class="mt-3 col-span-9">
        ...
        <textarea :name="'question_description_' + model.id" v-model="model.description" @change="dataChange"
            :id="'question_description_' + model.id" class="mt-1
                    focus:ring-indigo-500 focus:border-indigo-500
                    block
                    w-full
                    p-2
    ...
    <div>
        <div v-if="shouldHaveOptions()" class="mt-2">
            <h4 class="text-sm font-semibold mb-1 flex justify-between items-center">
                ...
                <!-- Add new option -->
                <button type="button" @click="addOption()" class="flex
                            items-center
                            text-xs
                            py-1
                            px-2
            ...
            <div v-for="(option, index) in model.data.options" :key="option.uuid" class="flex items-center mb-1">
                ...
                <input type="text" tabindex="1" v-model="option.text" @change="dataChange" class="w-full
                        rounded-sm
                        py-1
                        px-2
                        text-xs
                    ...
                    " />
                <!-- Delete Option -->
                <button type="button" @click="removeOption(option)" class="h-6
                        w-6
                        rounded-full
                        flex
                        items-center
