        ...
        <form @submit.prevent="saveSurvey" class="animate-fade-in-down">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" v-model="model.title" autocomplete="survey_title"
                            class="mt-1 focus:ring-indigo-500 border px-3 py-2 border-gray-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm rounded-md" />
                    </div>
                    <!--/ Title -->
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3" v-model="model.description"
                                ...
                                class="shadow-sm focus:ring-indigo-500 border border-gray-500 px-3 py-2  focus:border-indigo-500 mt-1 block w-full sm:text-sm  rounded-md"
                    ...
                    <div>
                        ...
                        <input type="date" name="expire_date" id="expire_date" v-model="model.expire_date"
                            class="mt-1 focus:ring-indigo-500  px-3 py-2 border border-gray-500  focus:border-indigo-500 block w-full shadow-sm sm:text-sm  rounded-md" />
                    </div>
                    <!--/ Expire Date -->
              ...
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <!-- <div v-if="model.questions.length===0" class="text-center text-gray-600">
